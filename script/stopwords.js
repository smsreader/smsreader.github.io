const stopWordsArray = [
    ...
    'что попало', 'кто угодно', 'что угодно', 'нередко', 'ориентировочно', 'плюс-минус', 'повально', 'повальный', 'повальное', 'повальная', 
    ...
    'достойный лучшего применения', 'достойные лучшего применения', 'из года в', 'от раза к', 'каждый из нас', 'каждого из нас', 'каждому из нас', 'каждым из нас', 
    ...
    'по итогам', 'большое количество', 'на лоне', 'на ниве', 'front-end', 'back-end', 'full-stack', 'каждый из этапов', 'каждом из этапов', 'с тем с чем', 'на том на чем',
    'на том на чём', 'направлено на то чтобы', 'направлен на то чтобы', 'посмотреть как выглядит', 'думать про то что', 'думать про то как', 'думайте про то что',
    'думайте про то как', 'думайте про то чем', 'думать про то чем', 'забыть про', 'забывайте про', 'подсвечивать', 'подсвечивает',
    'подсвечивайте', 'установить на своём компьютере', 'установить на своем компьютере', 'решать вопросы', 'решить вопросы', 'решает вопросы', 'решают вопросы',
    'решит вопросы', 'решите вопросы', 'решать задачи бизнеса', 'решает задачи бизнеса', 'и многое другое', 'сможет помочь', 'может помочь', 'содержит в себе',
    'содержать в себе', 'содержат в себе', 'посмотреть как выглядит', 'посмотрите как выглядит', 'сможете найти', 'думайте про', 'думать про', 'думаете про', 
    'мотивировать на работу', 'мотивирует на работу', 'находится в курсе', 'находиться в курсе', 'очень широко', 'бывает что',
    'оставляет желать лучшего', 'если можно так выразиться', 'имеет право на существование', 'имеют право на существование',
    'имел право на существование', 'имело право на существование', 'имела право на существование', 'имели право на существование',
    'что-то пошло не так', 'свято верю', 'стезя', 'на выходе', 'адаптируюсь под ситуацию', 'адаптироваться под ситуацию',
    'доносить свои идеи', 'донести свои идеи', 'доносить свою идею', 'донести свою идею', 'доносить идеи', 'доносить идею',
    'вместе мы сможем больше', 'вместе мы можем больше', 'три моих главных кита', 'три кита', 'трех китах', 'трёх китах', 'имеет специальный тип',
    'в первую очередь', 'представлять из себя', 'представляет из себя', 'представлял из себя', 'представляют из себя', 'представляла из себя',
    'представляло из себя', 'представит из себя', 'к себе на компьютер', 'компьютер говорит', 'компьютер показывает', 'компьютер печатает'
    ];