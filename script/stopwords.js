const stopWordsArray = [
    ...
    'и вообще', 'и правда', 'иначе говоря', 'увы', 'к примеру', 'к сведению', 'к слову', 
    ...
    'всяческие', 'всяческая', 'всяческое', 'зачастую', 'и так далее', 'кто попало', 'куда попало', 
    ...
    'вырос в объеме',
    'вырос в объёме', 'растёт в объеме', 'растет в объеме', 
    'вырастает в объеме', 
    'рос в объеме',
    ...
    'обладал', 'позволяет', 'позволяющий', 'позволяющие', 'позволяющее', 'позволяющая', 'существующий', 
